...
(function () {
  ...
  function revealStaticNoGsap() {
    ...
    document
      .querySelectorAll("[data-hero-fade], .hero__label, .sticker-item")
  ...
  function initReducedMotion() {
    ...
    gsap.set(
      document.querySelectorAll("[data-hero-fade], .hero__label, .sticker-item"),
      { opacity: 1 }
    );
    document.body.classList.remove("is--loading");
    initInteractive();
  ...
  function initIntro() {
    ...
    // c. mono label fades up 12px
    if (label) {
      tl.to(label, { opacity: 1, y: 0, duration: 0.6 }, "-=0.5");
    }
